...
- 🌱 Learning **Python · Ansible · Kubernetes**
...
| | Repo | Description |
|-|------|-------------|
| 📋 | [testnet-history](https://github.com/AntNodes/MY-TESTNET) | Full history of testnet participation |
| 🌐 | [mainnet-validators](https://github.com/AntNodes/MY-MAINNETS) | Mainnet validator portfolio |
| 🤖 | [node-monitor-bot](https://github.com/AntNodes/SYNC) | Telegram bot — node alerts & status |
| 📖 | [manuals](https://github.com/AntNodes/MANUALS) | Node setup guides |
| ⚙️ | [node-manager](https://github.com/AntNodes/node-manager) | Automated node lifecycle script |
